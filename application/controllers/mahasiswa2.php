...
class Mahasiswa2 extends CI_Controller {
	...
	function index(){
		...
		$this->load->view('mahasiswa2/index', $a);
	}
	...
	public function cetak()
	{
		...
		$this->load->view('mahasiswa2/cetak', $data);
	}
	...
	public function nilai(){
		...
		$this->load->view('mahasiswa2/nilai', $data);
	}
	...
	public function dnilai($kode = 0){
		...
		$this->load->view('mahasiswa2/dnilai', $data);
	}
	...
	public function soal($id = 0){	
    	...
    	$soal2 = $this->model_soal->Ambil("where soal.jalur_tes = 'Ujian Bidikmisi' order by RAND()");
    	        
        $data = array(
			"soal" => $soal2->result_array(),
			"total_soal" =>$soal2->num_rows(),
			"id_jawaban" => $id,
		);

        $this->load->view('mahasiswa2/soal', $data);
    ...
    public function jawab(){
		...
		redirect('mahasiswa2/dnilai/'.$id_jawaban);
    }
}
