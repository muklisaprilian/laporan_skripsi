...
class Mahasiswa1 extends CI_Controller {
	...
	function index(){
		...
		$this->load->view('mahasiswa1/index', $a);
	}
	...
	public function cetak()
	{
		...
		$this->load->view('mahasiswa1/cetak', $data);
	}
	...
	public function nilai(){
		...
		$this->load->view('mahasiswa1/nilai', $data);
	}
	...
	public function dnilai($kode = 0){
		...
		$this->load->view('mahasiswa1/dnilai', $data);
	}
	...
	public function soal($id = 0){	
    	...
    	$soal1 = $this->model_soal->Ambil("where soal.jalur_tes = 'Ujian Jalur Mandiri' order by RAND()");
    	        
        $data = array(
			"soal" => $soal1->result_array(),
			"total_soal" =>$soal1->num_rows(),
			"id_jawaban" => $id,
		);

        $this->load->view('mahasiswa1/soal', $data);
    ...
    public function jawab(){
		...
		redirect('mahasiswa1/dnilai/'.$id_jawaban);
    }
}
