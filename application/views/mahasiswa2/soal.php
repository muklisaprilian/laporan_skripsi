...
<div class="row">
        ...
        <section class="content-header">
          <h1><i class="fa fa-list-ol faa-pulse animated"></i>
            Form Data Soal Ujian Bidikmisi
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>mahasiswa2/index"><i class="fa fa-home faa-pulse animated"></i> Home</a></li>
            <li class="active"><i class="fa fa-list-ol faa-pulse animated"></i> Form Data Soal Ujian Bidikmisi</li>
          </ol>
        </section>  
        </div>
        </div>
