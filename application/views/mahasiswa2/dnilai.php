...
<body>           
        ...
        <section class="content-header">
          <h1><i class="fa fa-list-ol faa-pulse animated"></i>
            Detail Data Hasil Ujian Bidikmisi
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>mahasiswa2/index"><i class="fa fa-home faa-pulse animated"></i> Home</a></li>
            <li><a href="<?php echo base_url(); ?>mahasiswa2/nilai"><i class="fa fa-table faa-pulse animated"></i> Tabel Data Hasil Ujian Bidikmisi</a></li>
            <li class="active"><i class="fa fa-list-ol faa-pulse animated"></i> Detail Data Hasil Ujian Bidikmisi</li>
          </ol>
        </section>  
        </div>
        </div>              
                ...
                <div class="col-md-12">                
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <b>Detail Hasil Ujian - <b href="#"><?php echo strtoupper($this->session->userdata('username')); ?></b></b>
                        </div>
