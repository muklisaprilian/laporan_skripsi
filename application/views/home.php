        ...
        <body style="background-color:#000a0a;">
          <center><img style="margin-top:5pt" src="<?php echo base_url(); ?>assets/image/bbb.png"></center>
             <form method="post">
               <div class="col-md-4 col-md-offset-4" style="margin-left:130px">
                    <div class="panel panel-default"><center><h4><b>Selamat Datang Admin !</b></h4></center>
                          <div class="panel-body"><h4>Silahkan input username serta password dan anda akan dialihkan ke menu utama, admin bertugas dan memiliki hak akses untuk melakukan operasi pengolahan data panitia, data calon mahasiswa, data fakultas, data program studi, dan data materi ujian.</h4>
                              <br>
                              <br>
                        </div>
                  </div>
          ...
          <form action="<?php echo base_url('login/masuk');?>" method="post">
               <div class="col-md-4 col-md-offset-4" style="margin-left:200px">
                    <div class="panel panel-default"><center><h4><b>Login Admin</b></h4></center>
