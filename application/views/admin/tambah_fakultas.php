        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-list-alt faa-pulse animated"></i> Tambah Data Fakultas</li>
              <!--
          ...
          <section class="content">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Silahkan Masukkan Data Fakultas</h3>
              </div>
              <div class="box-body">
              <div class="col-md-6">
                <!-- form start -->
                <?php echo form_open('admin/insert_fakultas'); ?>
              <div class="form-group">
                    <label for="exampleInputEmail1">Kode Fakultas</label>
                    <input type="number" class="btn-default" method="post" name="id" min="1011" max="10000" step="1" placeholder="1011" autocomplete="off" required/>
              </div>
             <div class="form-group">
                    <label for="exampleInputEmail1">Fakultas</label>
                    <input type="text" class="form-control" name="fakulti" placeholder="Fakultas" autocomplete="off" required/>
              </div>
