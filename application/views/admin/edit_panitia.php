        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-list-alt faa-pulse animated"></i> Edit Data Panitia</li>
              <!--
          ...
          <section class="content">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Silahkan Edit Data Panitia</h3>
              </div>
              <div class="box-body">
              <div class="col-md-6">
                <!-- form start -->
                <?php echo form_open('admin/update_panitia'); ?>
                <?php  
                foreach ($editdata as $data):
                ?>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Id Panitia</label>
                      <input class="btn-default" name="id" value="<?php echo $data->id_panitia; ?>" readonly/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama</label>
                      <input type="text" class="form-control" name="nama1" value="<?php echo $data->nama_panitia; ?>" autocomplete="off" required/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Username</label>
                      <input type="text" class="form-control" name="username1" value="<?php echo $data->username; ?>" autocomplete="off" required/>
                  </div>
                 <div class="form-group">
                    <label for="exampleInputEmail1">Password</label>
                      <input type="text" class="form-control" name="password1" value="<?php echo $data->password; ?>" autocomplete="off" required/>
                  </div>
                   <div class="form-group">
                  ...
                  <input type="hidden" name="id" value="<?php echo $data->id_panitia ?>">
