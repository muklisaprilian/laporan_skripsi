...
<div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>mahasiswa2">Aplikasi UMB</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
                    <li class="dropdown user-dropdown">
                     ...
                     <ul class="dropdown-menu">
                         <li class="divider"></li>
                         <li><a href="<?php echo base_url(); ?>login4/keluar" onclick="return confirm('Anda ingin keluar ?');"><i class="fa fa-power-off"></i> LOG OUT</a></li>
                     </ul>
                 </li>
             </ul>
         </div>
