<?php $this->load->view('include/headsis1') ?>
<body>           
        <div id="page-wrapper" >
        <div id="page-inner">
        <div class="row">
        ...
        <section class="content-header">
          <h1><i class="fa fa-table faa-pulse animated"></i>
            Tabel Data Hasil Ujian Jalur Mandiri
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index"><i class="fa fa-home faa-pulse animated"></i> Home</a></li>
            <li class="active"><i class="fa fa-table faa-pulse animated"></i> Tabel Data Hasil Ujian Jalur Mandiri</li>
          </ol>
        </section>  
                    </div>
                </div>              
                                ...
                                <table class="table table-striped table-bordered table-hover" >
                                    ...
                                    <?php $no=0; foreach($nilai as $kon) { $no++?>
                                        <tr>
                                            ...
                                            <td width='5%' align='center'><a class='btn btn-warning btn-xs' title='Detail' href="<?php echo base_url();?>mahasiswa1/dnilai/<?php echo $kon['id_jawaban']; ?>"><span class="glyphicon glyphicon-eye-open faa-pulse animated"></span> Detail</a>
                                            <a class='btn btn-success btn-xs' title='Cetak' href="<?php echo base_url();?>mahasiswa1/cetak"><span class="glyphicon glyphicon-print faa-pulse animated"></span> Cetak</a></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
