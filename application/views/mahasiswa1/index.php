...
<meta http-equiv="refresh" content="10">
  ...
  <body class="hold-transition skin-black sidebar-mini">
    <div class="wrapper">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">             
              ...
              <li class="dropdown">
                  ...
                  <div class="col-md-4">
          				 <button type="button" class="btn btn-default btn-sm"><a href="<?php echo base_url(); ?>login3/keluar" onclick="return confirm('Anda ingin keluar ?');"><b>LOG OUT</b></a></button>
                  </div>
        			  </ul>
      			  </li>              
            </ul>
      ...
      <?php $this->load->view('mahasiswa1/'.$page); ?>
