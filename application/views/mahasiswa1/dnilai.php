...
<body>           
        ...
        <section class="content-header">
          <h1><i class="fa fa-list-ol faa-pulse animated"></i>
            Detail Data Hasil Ujian Jalur Mandiri
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>mahasiswa1/index"><i class="fa fa-home faa-pulse animated"></i> Home</a></li>
            <li><a href="<?php echo base_url(); ?>mahasiswa1/nilai"><i class="fa fa-table faa-pulse animated"></i> Tabel Data Hasil Ujian Jalur Mandiri</a></li>
            <li class="active"><i class="fa fa-list-ol faa-pulse animated"></i> Detail Data Hasil Ujian Jalur Mandiri</li>
          </ol>
        </section>  
        </div>
        </div>              
