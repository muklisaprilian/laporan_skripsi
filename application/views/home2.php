  ...
  <head>
    ...
    <![endif]-->
        ...
        <body style="background-color:#000a0a;">
          <center><img style="margin-top:5pt" src="<?php echo base_url(); ?>assets/image/bbb.png"></center>
             <form method="post">
               <div class="col-md-4 col-md-offset-4" style="margin-left:130px">
                    <div class="panel panel-default"><center><h4><b>Selamat Datang Calon Mahasiswa !</b></h4></center>
                          <div class="panel-body"><h4>Silahkan input username serta password dan anda akan dialihkan ke menu utama, calon mahasiswa adalah orang yang diperbolehkan untuk melakukan operasi sesuai hak aksesnya dalam mengikuti ujian dan melihat hasil ujian.</h4>
          ...
          <form action="<?php echo base_url('login2/masuk');?>" method="post">
               <div class="col-md-4 col-md-offset-4" style="margin-left:200px">
                    <div class="panel panel-default"><center><h4><b>Login Calon Mahasiswa (UMB)</b></h4></center>
                          <div class="panel-body">
                              <div class="row form-group">
                              <label class="col-md-3"><i class=""></i></label>
                              <div class="col-md-9">
                                   <select name="jalur_tes" class="hidden" id="jalur_tes" placeholder="Jalur Tes" required>
                              ...
                              <div class="col-md-9" style="margin-top: -10pt">
                              <input type="password" name="password" class="form-control input-sm" id="password"  placeholder="Isi Dengan NISN Anda" autocomplete="off" required>
                              </div>
                              </div>
