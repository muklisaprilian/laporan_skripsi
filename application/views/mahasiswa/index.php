...
<meta http-equiv="refresh" content="10">
  ...
  <body class="hold-transition skin-black sidebar-mini">
    <div class="wrapper">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">             
              ...
              <li class="dropdown">
                  ...
                  <div class="col-md-4">
          				 <button type="button" class="btn btn-default btn-sm"><a href="<?php echo base_url(); ?>login2/keluar" onclick="return confirm('Anda ingin keluar ?');"><b>LOG OUT</b></a></button>
                  </div>
        			  </ul>
      			  </li>              
            </ul>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($page == 'soal'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>mahasiswa/daftar" onclick="return confirm(' Apakah anda sudah siap mengikuti ujian ?');">
            ...
            <li class="<?php if($page == 'logout'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>login2/keluar" onclick="return confirm('Anda ingin keluar ?');">
      ...
      <?php $this->load->view('mahasiswa/'.$page); ?>
