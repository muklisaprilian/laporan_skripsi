...
<body>           
        ...
        <section class="content-header">
          <h1><i class="fa fa-list-ol faa-pulse animated"></i>
            Detail Data Hasil Ujian Masuk Bersama
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>mahasiswa/index"><i class="fa fa-home faa-pulse animated"></i> Home</a></li>
            <li><a href="<?php echo base_url(); ?>mahasiswa/nilai"><i class="fa fa-table faa-pulse animated"></i> Tabel Data Hasil Ujian Masuk Bersama</a></li>
            <li class="active"><i class="fa fa-list-ol faa-pulse animated"></i> Detail Data Hasil Ujian Masuk Bersama</li>
          </ol>
        </section>  
        </div>
        </div>              
